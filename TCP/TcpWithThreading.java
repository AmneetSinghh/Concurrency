...
*/
public class TcpWithThreading {
    static final int PORT = 1727;
    ...
    static class ProcessRequest implements Runnable {
        ...
        public void run() {
            try {
                ...
                /*
                 * Decorator pattern -> when calling input.readline it will go through, first byte read, char read, buffer read/
                 */
